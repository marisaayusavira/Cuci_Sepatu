...
<body class="py-5">
    ...
    <div class="card">
        ...
        <div class="card-body">
        <form action="orderpaint.php" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                <label>Nama Layanan</label>
                <input type="hidden" name="faktur" value="SC<?= $faktur ?>">
                <input type="text" class="form-control" readonly name="layanan" value="Repaint">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label>Harga</label>
                <input type="text" class="form-control" readonly name="harga" value="150000">
            </div>
            <div class="form-group">
                <label>Jumlah Sepatu</label>
                <input type="number" class="form-control" name="jumlah" value="Standard Clean / Quick Clean">
            </div>
            <div align="right">
